...
//		hideImage = AbFileUtil.getBitmapFromSrc("image/play_hide.png");
		displayImage= BitmapFactory.decodeResource(getResources(), R.mipmap.slide_display_dian);
		hideImage= BitmapFactory.decodeResource(getResources(), R.mipmap.slide_hide_dian);
